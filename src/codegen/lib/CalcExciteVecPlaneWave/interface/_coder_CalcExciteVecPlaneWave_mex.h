 ...
 *
 * _coder_CalcExciteVecPlaneWave_mex.h
 *
 * Code generation for function '_coder_CalcExciteVecPlaneWave_mex'
 *
 */

#ifndef _CODER_CALCEXCITEVECPLANEWAVE_MEX_H
#define _CODER_CALCEXCITEVECPLANEWAVE_MEX_H
...
/* End of code generation (_coder_CalcExciteVecPlaneWave_mex.h) */
