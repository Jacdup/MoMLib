function [] = PlotCurrentDir3D(tri,quad_nodes,node_coords,centroid_flowdirs, centroid_flowdirs_imag)
...
PlotMesh(node_coords,quad_nodes, quad_nodes,tri);
hold on
quiver3(centroid_coords(:,1),centroid_coords(:,2),centroid_coords(:,3),centroid_flowdirs(:,1),centroid_flowdirs(:,2),centroid_flowdirs(:,3), 2,'LineWidth', 2);
