...
col = [0; 1];
figure
patch('Faces',elements1,'Vertices',points1,'FaceVertexCData',col,'FaceColor','white')
...
% figure
quiver3(Ruv(:,1),Ruv(:,2),Ruv(:,3), Delta(:,1), Delta(:,2), Delta(:,3), 1,'LineWidth', 2,'MaxHeadSize',5);
