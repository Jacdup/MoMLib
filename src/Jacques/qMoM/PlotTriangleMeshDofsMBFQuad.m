...
%     for col = 4:3:length(U_Mat(1,:))
        for ii = 1:num_dofs
            ...
            if U_Mat(ii,4) ~= 0
                ...
                text(edge_midpoints(thisedge,1),edge_midpoints(thisedge,2),edge_midpoints(thisedge,3),[' ',num2str(U_Mat(ii,5))],'HorizontalAlignment','left','Color','r');
