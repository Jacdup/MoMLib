function [I_vec] = ScaleEndCapCurrent(DOF_mat1, DOF_mat,theta1, theta2, I_vec)
...
I_vec(second_endcap_circ(2:2:end)) = dot(I_vec(second_endcap_circ(2:2:end)),repelem((current_maxVal_endcap2), length(first_endcap_circ)/2));
end