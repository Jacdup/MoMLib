function [new_triangles, new_points, new_N, observer_map, source_map] = BasisFunctionSelect(triangles, basis_select, basis_supports, points)
%Robey Beswick
%Februaury 2019
%18472648@sun.ac.za
%
...
for tri_index = 1:size(new_triangles,1)
    ...
    tri = new_triangles(tri_index,1:3);
